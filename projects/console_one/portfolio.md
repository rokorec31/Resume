...
![Dashboard Screenshot - Device Status](./assets/dashboard_device_status.png)
> ✨ **Highlight:** Showcases the clean dashboard design and real-time device connectivity status.

### Voice Call Interface
![Voice Call Screenshot - Voice Call](./assets/voice_call_interface.png)
> ✨ **Highlight:** Features the Active Call Bar along with the dial pad and in-call interaction UI.

### Recordings Management
![Recordings Placeholder](https://via.placeholder.com/800x450/1e293b/ffffff?text=Recordings+Management)
> ✨ **Highlight:** A structured data list view integrated with a custom audio player.

### Hotkey Settings
![Hotkey Settings Screenshot - Hotkey Settings](./assets/hotkey_settings.png)
